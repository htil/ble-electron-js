...
export const MuseGraph = class {
    ...
    get_formatted_data(i) {
        return {
            TP9: this.recent_data_temp[0][i] + (this.height * .1),  //F8
            TP10: this.recent_data_temp[1][i]+ (this.height * .2),  //F7
            AF8: this.recent_data_temp[2][i] + (this.height * .3),  //TP9
            AF7: this.recent_data_temp[3][i] + (this.height * .4)   // TP10
        }
    }
